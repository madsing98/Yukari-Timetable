...
void Arduino_ST7789::setRotation(uint8_t m) {
  ...
  case 1:
     ...
     writedata(ST7789_MADCTL_MV | ST7789_MADCTL_MX | ST7789_MADCTL_RGB);
     _ystart = _colstart;
     _xstart = _rowstart;
     break;
...
void Arduino_ST7789::setAddrWindow(uint8_t x0, uint8_t y0, uint8_t x1, uint8_t y1) {
...
void Arduino_ST7789::pushColorBuf(void *buf, size_t count) {
  SPI_BEGIN_TRANSACTION();
  DC_HIGH();
  CS_LOW();
